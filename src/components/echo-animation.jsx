...
const EchoAnimation = () => {
  return (
    <div className="md:w-[230px] md:h-[104px] shrink-0 relative flex items-center justify-center">
        ...
        <span className="text-white text-[50px] text-center font-medium  z-10 top-0 right-0">Echo</span>
    </div>
  )
}
