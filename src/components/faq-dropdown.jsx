...
const FaqDropdown = ({ question, answer, isDown, onToggle }) => {
  return (
    <div className="w-full">
      ...
      >
        <span className="font-medium text-[16px] md:text-[18px] leading-[29px] -tracking-[.26px] text-left">
          {question}
        </span>
      ...
      <div className={`overflow-hidden transition-all duration-300 ease-in-out ${
        ...
        <div className="px-8 py-6 border-t-2 border-border bg-[rgba(255,255,255,.9)] text-[14px] md:text-[16px] leading-[26px] text-gray-700">
          {answer}
        </div>
      </div>
    </div>
